...
nextcyl:
	ld		a,(cylinder)
	ld		b,406
	; We don't actually need to increment for this test
;	inr		a	
	sub		a,b
	bz		done
	st		a,(cylinder)
...
str_hello:
	.ascii "HAWK DRIVE READ TEST V0.1.0"
	.byte	0x00
str_crlf:
	.byte	0x0D,0x0A,0x00
