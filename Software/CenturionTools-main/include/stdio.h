...
/* FIXME: these 4 ought to come from a per target header
   as does the type - but make it other than long at your peril! */

typedef long off_t;

#define BUFSIZE 	512	/* Buffer/block size */
#define BUFSIZELOG	9	/* Buffer/block size log2 */
#define BUFSIZ		256
#define PATHLEN 	512
...
/* These are really from target libraries */
