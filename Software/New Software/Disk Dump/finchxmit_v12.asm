...
TOP       JSR/      PRINTNULL
          DW        X'8D8A'
          DC        'THE FINCH HAS X025C TOTAL TRACKS'
          DW        X'8D8A'
...
ETRACK    DW        X'025C'        ; Define ending track
...
PICKST    JSR/      FILLSTR        ; Jump to routine that fills incoming ASCII
          ...
          CLAB                     ; Set AL to all 0's
          STAB/     READCMD+3      ; Zero out Disk starting number
          STAB/     READCMD+8      ; Zero out Sector starting number
...
INCRMNT1  LDAB/     READCMD+8      ; Load the sector count into AL
          ...
          LDAB=     X'1C'          ; Load max sector count into AL
