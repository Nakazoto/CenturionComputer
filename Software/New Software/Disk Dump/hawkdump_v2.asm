...
********************************************************************************
*
PICKDR    JSR/      PRINTNULL      ; Print some stuff
          DW        X'8D8A'
          ...
          DB        0              ; Null terminator
          JSR/      WAITRDY        ; Jump to the subroutine to get input
...
PICKSTEN  JSR/      PRINTNULL      ; Print some stuff
          DW        X'8D8A'
          DC        'ENTER STARTING CYLINDER IN HEX (0 ~ 190): '
          DB        0              ; Null terminator
          JSR/      WAITRDY        ; Jump to the subroutine to get input
<! FINISH OUT START AND END HERE !>


          <! Grab byte, drop it somewhere, grab next byte, repeat 4 times !>
