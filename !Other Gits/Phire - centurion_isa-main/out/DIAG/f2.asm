...
8849:    90 07 cc     ld AX, #0x07cc
884c:    50 80        add AX, EX
884e:    7d 00        call (A + 0x00)
8850:    "\x1b\x1c\x0cCPU INSTRUCTION TEST, CONTROL-C TO EXIT\r\n\0"
887d:    6d a2        st RT, -(SP)
887f:    55 80        mov AX, EX
8881:    b5 a2        st AX, -(SP)
8883:    60 00 20     ld RT, #0x0020 ; This is a testing that the 60 3 byte instruction is working.
...
8886:    90 05 a1     ld AX, #0x05a1
8889:    50 80        add AX, EX
888b:    5c           mov DX, AX ; This might be installing an exception handler?
888c:    90 00 10     ld AX, #0x0010
...
894f:    06           fsc
8950:    02           fsn
8951:    22 60        clr DH ; Using 60 in the operand means the following branch will be skipped
...
L_8ad2:
8ad2:    90 00 00     ld AX, #0x0000
8ad5:    14 01        bz L_8ad8
8ad7:    00           HALT

L_8ad8:
8ad8:    60 80 00     ld RT, #0x8000
...
L_8b23:
8b23:    90 55 55     ld AX, #0x5555
8b26:    d0 55 55     ld BX, #0x5555
...
L_8b65:
8b65:    90 aa 55     ld AX, #0xaa55
8b68:    55 02        mov BX, AX
8b6a:    55 04        mov RT, AX
8b6c:    55 06        mov DX, AX
8b6e:    55 08        mov EX, AX
8b70:    55 8a        mov SP, EX
8b72:    55 8c        mov GX, EX
8b74:    55 80        mov AX, EX
8b76:    50 20        add AX, BX
8b78:    50 40        add AX, RT
8b7a:    50 60        add AX, DX
8b7c:    51 08        sub EX, AX
8b7e:    51 8a        sub SP, EX
8b80:    51 ac        sub GX, SP
8b82:    51 c2        sub BX, GX
8b84:    14 01        bz L_8b87
8b86:    00           HALT

L_8b87:
8b87:    d0 55 aa     ld BX, #0x55aa
8b8a:    44 67        xor DL, DH
8b8c:    44 76        xor DH, DL
8b8e:    44 67        xor DL, DH
8b90:    54 62        xor BX, DX
...
8b99:    44 c8        xor EH, GH
8b9b:    44 d9        xor EL, GL
8b9d:    55 88        mov EX, EX
8b9f:    14 01        bz L_8ba2
8ba1:    00           HALT

L_8ba2:
8ba2:    90 80 00     ld AX, #0x8000
8ba5:    d0 00 01     ld BX, #0x0001
8ba8:    59           sub! BX, AX
...
L_8bc0:
8bc0:    90 aa aa     ld AX, #0xaaaa
8bc3:    d0 55 55     ld BX, #0x5555
8bc6:    5e           mov EX, AX
8bc7:    5b           or! BX, AX
8bc8:    5a           and! BX, AX
...
L_8bd0:
8bd0:    55 82        mov BX, EX
8bd2:    55 40        mov AX, RT
8bd4:    5a           and! BX, AX
8bd5:    51 40        sub AX, RT
8bd7:    14 01        bz L_8bda
8bd9:    00           HALT

L_8bda:
8bda:    91 bf fc     ld AX, (0xbffc)
8bdd:    5e           mov EX, AX
8bde:    91 00 26     ld AX, (0x0026)
8be1:    14 01        bz L_8be4
8be3:    00           HALT

L_8be4:
8be4:    d1 00 24     ld BX, (0x0024)
8be7:    16 01        blt L_8bea
8be9:    00           HALT

L_8bea:
8bea:    61 00 22     ld RT, (0x0022)
8bed:    18 01        bgt L_8bf0
8bef:    00           HALT

L_8bf0:
8bf0:    b1 00 2c     st AX, (0x002c)
8bf3:    14 01        bz L_8bf6
8bf5:    00           HALT

L_8bf6:
8bf6:    91 00 2c     ld AX, (0x002c)
8bf9:    f1 00 2c     st BX, (0x002c)
8bfc:    16 01        blt L_8bff
8bfe:    00           HALT

L_8bff:
8bff:    d1 00 2c     ld BX, (0x002c)
8c02:    69 00 2c     st RT, (0x002c)
8c05:    18 01        bgt L_8c08
8c07:    00           HALT

L_8c08:
8c08:    61 00 2c     ld RT, (0x002c)
8c0b:    54 42        xor BX, RT
8c0d:    58           add! BX, AX
8c0e:    33 20        not BX
...
L_8c13:
8c13:    91 bf fc     ld AX, (0xbffc)
8c16:    5e           mov EX, AX
8c17:    91 00 10     ld AX, (0x0010)
8c1a:    50 80        add AX, EX
8c1c:    b1 00 10     st AX, (0x0010)
8c1f:    91 00 12     ld AX, (0x0012)
8c22:    50 80        add AX, EX
8c24:    b1 00 12     st AX, (0x0012)
8c27:    91 00 14     ld AX, (0x0014)
8c2a:    50 80        add AX, EX
8c2c:    b1 00 14     st AX, (0x0014)
8c2f:    91 00 16     ld AX, (0x0016)
8c32:    50 80        add AX, EX
8c34:    b1 00 16     st AX, (0x0016)
8c37:    91 00 18     ld AX, (0x0018)
8c3a:    50 80        add AX, EX
8c3c:    b1 00 18     st AX, (0x0018)
8c3f:    92 00 12     ld AX, @(0x0012)
8c42:    18 01        bgt L_8c45
8c44:    00           HALT

L_8c45:
8c45:    d2 00 14     ld BX, @(0x0014)
...
L_8c51:
8c51:    94 1c        ld AX, @(PC+0x1c)
8c53:    18 01        bgt L_8c56
8c55:    00           HALT

L_8c56:
8c56:    d4 19        ld BX, @(PC+0x19)
...
L_8c61:
8c61:    93 0c        ld AX, (PC+0xc)
8c63:    d3 0c        ld BX, (PC+0xc)
8c65:    58           add! BX, AX
8c66:    90 ff ba     ld AX, #0xffba
8c69:    58           add! BX, AX
...
L_8c73:
8c73:    60 00 20     ld RT, #0x0020
8c76:    9a           ld AX, (RT)
8c77:    d0 ff ff     ld BX, #0xffff
8c7a:    59           sub! BX, AX
...
L_8c9c:
8c9c:    d0 00 24     ld BX, #0x0024
8c9f:    9a           ld AX, (RT)
8ca0:    65 28 fe     ld RT, -0x2(BX)+
8ca3:    54 40        xor AX, RT
8ca5:    14 01        bz L_8ca8
8ca7:    00           HALT

L_8ca8:
8ca8:    95 28 fc     ld AX, -0x4(BX)+
8cab:    65 29 02     ld RT, +0x2-(BX)
8cae:    50 40        add AX, RT
8cb0:    3b           not! AX
...
L_8cb4:
8cb4:    99           ld AX, (BX)
8cb5:    65 2a fc     ld RT, unknown_indexed
8cb8:    54 40        xor AX, RT
8cba:    3b           not! AX
8cbb:    14 01        bz L_8cbe
8cbd:    00           HALT

L_8cbe:
8cbe:    60 00 10     ld RT, #0x0010
8cc1:    95 44        ld AX, unknown_indexed
8cc3:    d0 ff ff     ld BX, #0xffff
8cc6:    59           sub! BX, AX
8cc7:    14 01        bz L_8cca
8cc9:    00           HALT

L_8cca:
8cca:    95 45        ld AX, unknown_indexed
8ccc:    3b           not! AX
8ccd:    14 01        bz L_8cd0
8ccf:    00           HALT

L_8cd0:
8cd0:    95 45        ld AX, unknown_indexed
8cd2:    d5 45        ld BX, unknown_indexed
...
L_8cda:
8cda:    95 46        ld AX, unknown_indexed
8cdc:    d5 46        ld BX, unknown_indexed
...
L_8ce4:
8ce4:    60 00 14     ld RT, #0x0014
8ce7:    95 44        ld AX, unknown_indexed
8ce9:    d5 4c fe     ld BX, unknown_indexed
...
L_8cf2:
8cf2:    95 4c fc     ld AX, unknown_indexed
8cf5:    d5 4d 02     ld BX, unknown_indexed
...
L_8cfe:
8cfe:    95 44        ld AX, unknown_indexed
8d00:    d5 4e fc     ld BX, unknown_indexed
...
L_8d09:
8d09:    0d           unknown
8d0a:    90 05 0a     ld AX, #0x050a
8d0d:    50 80        add AX, EX
8d0f:    51 04        sub RT, AX
8d11:    14 01        bz L_8d14
8d13:    00           HALT

L_8d14:
8d14:    90 00 3a     ld AX, #0x003a
8d17:    5f           mov SP, AX
8d18:    60 20 20     ld RT, #0x2020
...
L_8d38:
8d38:    60 09 ef     ld RT, #0x09ef
8d3b:    90 11 ff     ld AX, #0x11ff
8d3e:    b5 41        st AX, (RT)+
8d40:    55 42        mov BX, RT
8d42:    90 09 f1     ld AX, #0x09f1
8d45:    59           sub! BX, AX
8d46:    14 01        bz L_8d49
8d48:    00           HALT

L_8d49:
8d49:    60 09 ef     ld RT, #0x09ef
8d4c:    95 41        ld AX, (RT)+
8d4e:    d0 11 ff     ld BX, #0x11ff
...
L_8d5a:
8d5a:    90 60 66     ld AX, #0x6066
8d5d:    2f 00        dma_load_addr WX
8d5f:    2f 21        dma_store_addr YZ
8d61:    59           sub! BX, AX
8d62:    14 01        bz L_8d65
8d64:    00           HALT

L_8d65:
8d65:    90 46 11     ld AX, #0x4611
8d68:    2f 02        dma_load_count WX
8d6a:    2f 23        dma_store_count YZ
8d6c:    59           sub! BX, AX
...
8d82:    61 bf fe     ld RT, (0xbffe)
8d85:    91 bf fc     ld AX, (0xbffc)
8d88:    d0 07 74     ld BX, #0x0774
8d8b:    58           add! BX, AX
8d8c:    75 20        jump (A + 0x20)

L_8d8e:
8d8e:    a1 f1 0a     st AL, (0xf10a)
8d91:    90 bf fc     ld AX, #0xbffc
8d94:    5f           mov SP, AX
8d95:    95 a1        ld AX, (SP)+
8d97:    5e           mov EX, AX
8d98:    65 a1        ld RT, (SP)+
8d9a:    90 00 7d     ld AX, #0x007d
8d9d:    50 80        add AX, EX
...
8dbb:    90 07 cc     ld AX, #0x07cc
8dbe:    50 80        add AX, EX
...
8df5:    90 07 cc     ld AX, #0x07cc
8df8:    50 80        add AX, EX
8dfa:    7d 00        call (A + 0x00)
8dfc:    "\r\n*** THIS TEST WILL NOT RUN ON CPU-5 ***\r\n\0"
8e28:    90 07 8a     ld AX, #0x078a
8e2b:    50 80        add AX, EX
8e2d:    75 00        jump (A + 0x00) ; Press Space to Exit

MappingRamTestLoop:
8e2f:    90 06 d9     ld AX, #0x06d9
8e32:    50 80        add AX, EX
...
8e6e:    90 07 74     ld AX, #0x0774
8e71:    50 80        add AX, EX
...
8e7f:    5e           mov EX, AX
8e80:    20 80        inc EH
8e82:    60 00 20     ld RT, #0x0020

nextMemoryLcation:
8e85:    d0 01 00     ld BX, #0x0100

nextByteValue:
8e88:    8b           ld AL, (DX) ; EF = 0x120 or 0x140 etc
8e89:    28           inc! AL
8e8a:    ab           st AL, (DX)
8e8b:    ac           st AL, (EX) ; HL is EF+0x100
...
8e99:    31 20        dec BX ; Test every single byte pattern
...
8eb8:    6d a2        st RT, -(SP)
8eba:    a5 a2        st AL, -(SP)
8ebc:    60 06 c2     ld RT, #0x06c2
8ebf:    50 84        add RT, EX
8ec1:    0f           unknown
...
8f2f:    65 a1        ld RT, (SP)+
8f31:    90 07 cc     ld AX, #0x07cc
8f34:    50 80        add AX, EX
8f36:    7d 00        call (A + 0x00)
8f38:    "\r\n*** MAP RAM ERROR ***\r\n\0"
8f52:    a1 f1 0b     st AL, (0xf10b)
8f55:    a1 f1 0c     st AL, (0xf10c)
8f58:    90 07 8a     ld AX, #0x078a
8f5b:    50 80        add AX, EX
8f5d:    75 00        jump (A + 0x00)

Entry_ROM_SELF_TEST:
8f5f:    55 86        mov DX, EX
8f61:    3a           clr! AX

ChecksumLoop:
8f62:    85 61        ld AL, (DX)+ ; Load Byte via base+index, post-increment index
8f64:    40 10        add AH, AL
8f66:    d0 07 dd     ld BX, #0x07dd
8f69:    50 82        add BX, EX
8f6b:    51 62        sub BX, DX
8f6d:    15 f3        bnz ChecksumLoop
8f6f:    8b           ld AL, (DX) ; Load Byte via base+index
